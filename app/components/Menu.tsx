    ...
    const categories: Category[] = [
        {
            ...
            items: [
                ...
                { name: "Medio Pollo", price: "$129", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Pollo & Sirloin", price: "$549", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Pollo & Costilla", price: "$449", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Pollo Consentido", price: "$239", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Pollo Nopalero", price: "$319", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Pollo Entero", price: "$219", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Pollo & Arrachera", price: "$420", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Paquete Personal de Pollo", price: "$169", image: "/menu/pollo-toluqueno.jpg" },
            ],
        },
        {
            id: "carnes",
            ...
            emoji: "🥩",
            items: [
                { name: "Itacate 4", price: "$949", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Itacate de Rib Eye", price: "$480", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Costilla Cargada", price: "$249", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Itacate Sirloin", price: "$339", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Itacate de New York", price: "$420", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Itacate 2 (Arrachera Parrillera)", price: "$359", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Itacate 3", price: "$489", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Itacate 1 (Parrillada 1kg)", price: "$375", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Itacate de Picaña", price: "$389", image: "/menu/pollo-toluqueno.jpg" },
            ],
        },
        {
            id: "combos",
        ...
        },
        {
            ...
            emoji: "📦",
            items: [
                { name: "Pollo & Barbacoa", price: "$549", image: "/menu/pollo-toluqueno.jpg" },
                { name: "Paquete Atasques", price: "$849", image: "/menu/pollo-toluqueno.jpg" },
            ],
        },
        {
            id: "salsas",
            ...
            emoji: "🌶️",
            items: [
                { name: "Chicharrón de Serrano con Ajo y Cebolla", price: "$120", image: "/menu/pollo-toluqueno.jpg", description: "Bote de 12 Oz" },
                { name: "Serrano Ahumado", price: "$120", image: "/menu/pollo-toluqueno.jpg", description: "Bote de 12 Oz" },
                { name: "Salsa de 7 Chiles", price: "$120", image: "/menu/pollo-toluqueno.jpg", description: "Bote de 12 oz" },
            ],
        },
    ];
